# 🎮 Eric Pacheco - Game Developer Portfolio
...
### 🎮 Gar-espacheco
**Advanced third-person shooter with intelligent AI and complete game systems**
- **Engine:** Unreal Engine
- **Language:** C++
- **Focus:** Enhanced AI systems, game-complete features, polished gameplay
- **Repository:** [Gar-espacheco](https://github.com/espacheco/Gar-espacheco)
- **Key Features:**
  - Advanced AI agent behavior and intelligence
  - Win/Lose condition systems
  - Enemy spawner with dynamic difficulty
  - Complete gameplay polish and balance
